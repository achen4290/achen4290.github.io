...
import { NodeState, ContextStorage, SavedDataType, SkillData, NodeSelectEvent } from '../models';
...
declare type DefaultProps = {
    handleSave: (storage: ContextStorage, id: string, skills: SavedDataType) => void;
