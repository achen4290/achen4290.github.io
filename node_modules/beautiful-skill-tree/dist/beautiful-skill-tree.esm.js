import React__default, { createContext, useState, useReducer, createElement, useContext, useMemo, memo, Fragment, useEffect, useRef, forwardRef, useCallback, Component } from 'react';
import { v4 } from 'uuid';
...
function SkillTreeGroup(_ref) {
  ...
  var skillTreeTheme = useMemo(function () {
...
memo(function (_ref) {
  ...
  }, createElement(Title, null, title), createElement("img", {
    onClick: handleClose,
    style: {
      width: '16px',
...
forwardRef(function Node(props, ref) {
  ...
  var memoizedHandleKeyDown = useCallback(function handleKeyDown(e) {
    if (e.keyCode === 13) {
      handleClick();
    }
  }, [handleClick]);
  ...
  return createElement(StyledNode, {
    onClick: handleClick,
    ...
    color: color
  }, 'icon' in skill ? createElement(IconNode, null, createElement(Icon, {
    title: "node-icon",
    src: skill.icon,
    containerWidth: 64
  })) : createElement(TextNode, null, color === 'default' ? createElement(Text, null, skill.title) : createElement(AlternativeText, {
    selected: currentState === SELECTED_STATE
  }, skill.title)));
});
var shadowburst =
...
function SkillNode(_ref) {
  ...
  return createElement(Fragment, null, createElement(StyledSkillNode, null, createElement(SkillNodeOverlay, {
    ...
    skill: skill,
    ref: skillNodeRef
  }))), children.length > 0 && createElement(SkillTreeSegmentWrapper, null, children.map(function (child) {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    return createElement(SkillContext.Provider, {
      value: {
...
function SkillTree(_ref) {
  ...
  var memoizedToggleVisibility = useCallback(function toggleVisibility() {
    if (disabled) {
      return setVisibility(false);
    }
